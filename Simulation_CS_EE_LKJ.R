...
option_list <- list(
  ...
  make_option(c("-K", "--NPL"), type="integer", default = 8,
              ...
              metavar="number"),
  make_option(c("-R", "--nRetrievals"), type="integer", default = 500,
              help="helpmessage goes here",
              metavar="number"),
...
#          }
#          
          benchmarks_subject_pars <-cbind(conN, conK,conRet,con_nFT, conFT,
          ...
          hyper_pars <- cbind(n,conN,conK,conRet,con_nFT,conFT,
                                                  meanPC = tapply(data[,3],data[,2],  "mean"),
                                                  minPC = tapply(data[,3],data[,2],  "min"),
                                                  maxPC = tapply(data[,3],data[,2],  "max"),
                                                  Mean_Apar, 
